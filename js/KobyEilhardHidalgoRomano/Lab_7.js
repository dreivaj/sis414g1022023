    ...
    if (contactList instanceof Array) {
        switch (sortBy) {
            case 'name':
                ...
                break;
            case 'phone':
                contactList.sort((a, b) => a.phone.localeCompare(b.phone));
                break;
            case 'email':
                contactList.sort((a, b) => a.email.localeCompare(b.email));
                break;
            default:
                console.log('Opción de ordenación no válida.');
                break;
        }
    }
}
...
while (true) {
    ...
    switch (opcion) {
        ...
        case "3":
            ...
            break;
        case "4":
            let sortOption = prompt("Seleccione cómo desea ordenar los contactos (por (name, phone, email)):");
